...
import { generateScenarios } from "@/lib/probability/engine";
...
export async function GET(
  ...
  const scenarios = generateScenarios(sym, analysis, smc, mtf);
  return NextResponse.json({ scenarios, time: Date.now() });
}
